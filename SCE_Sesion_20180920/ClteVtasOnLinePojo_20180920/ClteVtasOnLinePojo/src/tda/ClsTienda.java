...
// ---------------------------------------------------------------------------
 ...
 // ---------------------------------------------------------------------------    
    public MiModelo obtenModeloEntidad( String strEntidad, String strCondicion ) throws SQLException
    {
   ...
   // ---------------------------------------------------------------------------
   public MiModelo obtenModeloEntidades(String strEntidad) throws SQLException
   {
      // Operación solamente de utilería, para asistir al desarrollo eliminarla en producción
   ...
   // -------------------------------------------------------------------------
   public Customer buscaCustomer( String strCustomerID) throws SQLException
   {
   ...
   // -------------------------------------------------------------------------
   public Prod buscaProd( String strStockCode ) throws SQLException
   {
      Prod prod             = null;
      java.sql.ResultSet rs = null;
   ...
   public java.sql.ResultSet buscaEntidad( String strEntidad,
                               ...
                               String strValorLlave ) throws SQLException
   {
       java.sql.ResultSet rs = null;
   ...
   // ------------------------------------------------------------------------
   public boolean altaCUSTOMER(long lngCveCustomer, String strPais) throws SQLException
   {
...
// ---------------------------------------------------------------------------    
    ...
    {
        return conexion.obtenRS ("CUSTOMERSssss");
    }
// ---------------------------------------------------------------------------    
