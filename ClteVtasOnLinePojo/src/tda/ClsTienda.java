...
// ---------------------------------------------------------------------------
 ...
 // ---------------------------------------------------------------------------    
   ...
   public boolean altaCUSTOMER(long lngCveCustomer, String strPais)
   {
       ...
       return altaEntidad("CUSTOMERS", arr_nomCampos, arr_datos);
   }
   // ---------------------------------------------------------------------
   public boolean altaPRODUCT(String cveProduct, String strDescription, double dblPU)
   {
       ...
       return altaEntidad("PRODUCTS", arr_nomCampos, arr_datos);
   }
   // ------------------------------------------------------------------------
   //  Alta genérica y privada (NO SE EJERCE DESDE FUERA DE LA CLASE)
   // ------------------------------------------------------------------------
   private boolean altaEntidad(String strEntidad, String arr_nomCampos[], String arr_datos[])
    {
      int i,n;
...
// ---------------------------------------------------------------------------
    public static void main(String args[])
    {
        ...
        if( tienda.conectado())
        {
          ...
          Customer customer;
          customer = tienda.buscaCustomer("50944");
