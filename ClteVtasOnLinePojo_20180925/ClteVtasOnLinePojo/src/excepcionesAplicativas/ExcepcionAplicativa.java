...
public class ExcepcionAplicativa extends Exception
{
     ...
     * @param e
     */
    public ExcepcionAplicativa(ClsTienda tda,long unNum_Codigo, Exception e,String strDesc)
    {
        ...
        tda.MI_LOGGER.info(unNum_Codigo+""+strDonde+""+e.getMessage());
    }
