   ...
   public boolean altaCUSTOMER(long lngCveCustomer, String strPais)
   {
       ...
       //
        ...
        //if(customer == null)
         ...
         MI_LOGGER.info("tratando de dar de alta customer "+lngCveCustomer);
        ...
        catch (Exception ex) 
        {
            ...
            //ea.printStackTrace();
            MI_LOGGER.info("problema al dar de alta customer "+lngCveCustomer+ea);
            System.out.println("-------------------------------------------------------------------");
...
// ---------------------------------------------------------------------------
    public static void main(String args[])
    {
        ...
        try{
            ...
            Logger.getLogger(ClsTienda.class.getName()).log(Level.SEVERE, "No se pudo");
        }
